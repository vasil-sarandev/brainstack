...
**Where** production workloads run — the compute or hosting layer you deploy *to*. Distinct from [rollout strategies](../deployment-and-release-engineering/assets/deployment-strategies.md) (rolling, blue/green, canary), which describe *how* a new version replaces the old one on any target.
...
- [Deploy to EC2](ec2.md) — JARs, binaries, systemd, CodeDeploy, ASG + ALB
...
| --- | --- | --- | --- | --- |
| EC2 | Non-containerized apps, legacy stacks, full VM control | JAR, binary, tarball | S3, Artifactory | Copy + restart, CodeDeploy, ASG refresh |
...
Worked example (ECS + Kafka): [node-distributed-monolith case study](../case-studies/node-distributed-monolith.md).

---

## Related

- [Autoscaling](../deployment-and-release-engineering/assets/autoscaling.md) — ASG, ECS Service Auto Scaling, HPA
- [Deployment & Release Engineering](../deployment-and-release-engineering/deployment-and-release-engineering.md)
